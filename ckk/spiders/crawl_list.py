...
class DetailPages(scrapy.Spider):
    custom_settings = {
        "SITEMAP_URL": 'https://knifekits.com/vcom/smproducts.xml',
        "VIRTUAL_ENV":"/home/nyn11/dj-data/venv"
    }

    name = "detail_spider"
    allowed_domains = ['knifekits.com','holstersmith.com','localhost','127.0.0.1']
